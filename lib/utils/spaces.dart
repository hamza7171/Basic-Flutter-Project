...
///Use this class for padding, margins for x and y Axis
///E.g if you want margin from top you can use "Spaces.y2"
///These margins will calculate at run time according to screen size, so our UI become responsive
...
class Spaces{
  ...
  /// Use these widgets for space along Y-Axis (for height)
